...
def draw(trainLossList, validLossList):
    ...
    for i in range(len(validLossList)):
        valid_loss_list[i]/=(i+1)
...
if __name__ == "__main__":
    ...
    bestParam = (573120, 6, True, True, True, True)

    train_loss_list, valid_loss_list, acc, model, test_loader = trainOnce(*bestParam)
